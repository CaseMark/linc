...
import type { AssistantMessage, Model } from "@casemark/linc-ai";
...
vi.mock("@casemark/linc-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@casemark/linc-ai")>();
	return {
		...actual,

...
import type { AgentMessage, MessageRenderer } from "@casemark/linc-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@casemark/linc-web-ui";
...
declare module "@casemark/linc-agent-core" {
